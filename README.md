...
- **Saved Searches**: Save favorite search terms for quick 1-click access
...
4. **Saved Searches**: Use the "Saved Searches" tab to add, rename (click ✏️),
   delete (click 🗑️ twice), and reorder (drag the ⋮⋮ handle) favorite terms.
...
can restore that encrypted key bundle with a single passphrase entry.
